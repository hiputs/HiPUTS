 ...
 */
public class AStarContractionHierarchyPrecomputation<V, E>
{
    /**
     ...
     */
    public AStarContractionHierarchyPrecomputation(Graph<V, E> graph, ThreadPoolExecutor executor)
    {
     ...
     * @param executor executor which will be used for parallelization
     */
    public AStarContractionHierarchyPrecomputation(
            ...
            ThreadPoolExecutor executor)
    {
        ...
        updateNeighboursConsumer = this::updateNeighboursData;
