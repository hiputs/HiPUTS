...
//    przy new Con... jest zmiana względem kodu Pawła, bo coś się nei kompilowało
    ContractionHierarchyPrecomputation<JunctionReadable, LaneReadable> precomputation =
      new ContractionHierarchyPrecomputation<JunctionReadable, LaneReadable>(graph, (Supplier<Random>) executor);
