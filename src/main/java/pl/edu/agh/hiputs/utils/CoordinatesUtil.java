...
public class CoordinatesUtil {
  ...
  public static boolean isCoordinatesInsideRegion(double coordinateLongitude, double coordinateLatitude,
    ...
    return coordinateLongitude >= topLeftPointLongitude
        && coordinateLatitude <= topLeftPointLatitude
        && coordinateLongitude <= bottomRightPointLongitude
        && coordinateLatitude >= bottomRightPointLatitude;
  }
