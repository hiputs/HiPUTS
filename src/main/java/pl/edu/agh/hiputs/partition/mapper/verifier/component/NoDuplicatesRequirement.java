...
public class NoDuplicatesRequirement implements Requirement{
  ...
  private boolean noTrafficIndicatorsDuplicates(Graph<JunctionData, WayData> graph) {
    Set<String> tiIds = graph.getEdges().values().stream()
