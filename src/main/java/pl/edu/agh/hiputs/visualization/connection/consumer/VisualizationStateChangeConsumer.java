...
public class VisualizationStateChangeConsumer {
  ...
  @KafkaListener(topics = VISUALIZATION_STATE_CHANGE_TOPIC, groupId = VISUALIZATION_STATE_CHANGE_TOPIC,
      id = VISUALIZATION_STATE_CHANGE_TOPIC, autoStartup = "false",
  ...
  void stateChangeListener(ConsumerRecord<String, VisualizationStateChangeMessage> record) {
    ...
    log.info("Consumed VisualizationStateChangeMessage: stateChange={}, ROIRegion={}, ZoomLevel={}, TimeMultiplier={}",
        currentVisualizationStateChangeMessage.getStateChange(), currentVisualizationStateChangeMessage.getRoiRegion(),
        currentVisualizationStateChangeMessage.getZoomLevel(),
        currentVisualizationStateChangeMessage.getTimeMultiplier());
