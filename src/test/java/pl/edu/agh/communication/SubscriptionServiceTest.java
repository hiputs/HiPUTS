...
import pl.edu.agh.communication.model.messages.RunSimulationMessage;
...
public class SubscriptionServiceTest {
    ...
    void registerSubscriberAndCheckPropagateMessage() {
        ...
        Message message = NeighbourConnectionMessage.builder()
                .build();
    ...
    void registerSubscriberWithMultiMessagesAndCheckPropagateMessage() {
        // given
        PrimitiveSubscriber primitiveSubscriber = new PrimitiveSubscriber();
        Message message1 = NeighbourConnectionMessage.builder()
                .build();
