...
public class ChangeTypesFixerTest {

  private final ChangeTypesFixer fixer = new ChangeTypesFixer();
  ...
  @Test
  public void twoEdgesPredecessorToFixByNoKey() {
    // given
  ...
  @Test
  public void twoEdgesSuccessorToFixByNoValue() {
    // given
    Edge<JunctionData, WayData> edge1 = new Edge<>("1", WayData.builder().tags(new HashMap<>() {{
      put("highway", "motorway");
    }}).build());
    ...
    Assertions.assertEquals(2, resultGraph.getEdges().size());
    Assertions.assertEquals("motorway", edge1.getData().getTags().get("highway"));
    Assertions.assertEquals("motorway_link", edge2.getData().getTags().get("highway"));
  }
  ...
  public void threeEdgesAndTwoDifferentIncompatibilities() {
    ...
    Assertions.assertEquals("motorway_link", edge1.getData().getTags().get("highway"));
    Assertions.assertEquals("motorway", edge2.getData().getTags().get("highway"));
    Assertions.assertEquals("motorway_link", edge3.getData().getTags().get("highway"));
  }
