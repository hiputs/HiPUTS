...
public class RoadsPriorityCorrectorTest {
  private final RoadsPriorityCorrector corrector =
      new RoadsPriorityCorrector(new StandardPriorityProcessorChain(List.of(
          edges -> edges.isEmpty() ? Optional.empty() : Optional.of(edges.get(0)))));
