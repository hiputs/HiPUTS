...
public class CompletenessFilterTest {
  ...
  public void singleNodesWithoutRoads() {
    // given
    OsmGraph osmGraph = new OsmGraph(List.of(new Node(1L, 1, 1)), List.of(), List.of());
  ...
  public void waysWithoutHighway() {
    // given
    OsmGraph osmGraph = new OsmGraph(List.of(new Node(1L, 1, 1), new Node(2L, 2, 2)),
        List.of(new Way(1L, new TLongArrayList(new long[] {1L, 2L}))), List.of());
  ...
  public void waysWithoutRequiredNodes() {
    // given
    OsmGraph osmGraph = new OsmGraph(List.of(new Node(1L, 1, 1), new Node(2L, 2, 2)),
        List.of(new Way(1L, new TLongArrayList(new long[] {1L}))), List.of());
  ...
  public void happyPathWithNoFilter() {
    // given
    OsmGraph osmGraph = new OsmGraph(List.of(new Node(1L, 1, 1), new Node(2L, 2, 2)),
        List.of(new Way(1L, new TLongArrayList(new long[] {1L, 2L}), List.of(new Tag("highway", "primary")))),
        List.of());
