...
public class StandardRuleEngineTest {
  ...
  private final StandardRuleEngine standardRuleEngine = new StandardRuleEngine(
      List.of(new TypeOfRoadDecider(), new CountryDecider(new StandardCountryResolver()),
