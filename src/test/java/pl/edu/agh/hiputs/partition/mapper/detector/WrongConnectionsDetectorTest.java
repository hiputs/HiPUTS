...
public class WrongConnectionsDetectorTest {
  ...
  private final WrongConnectionsDetector detector = new WrongConnectionsDetector(
      wrongConnectionsCorrectorStrategyFactory, standardDetectorStrategyExecutor, finders);
  @Captor
