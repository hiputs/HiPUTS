...
public class StandardEdgeExtractorTest {
  ...
  private final static Edge<JunctionData, WayData> edge1 =
      new Edge<>("1", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge2 =
      new Edge<>("2", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge3 =
      new Edge<>("3", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge4 =
      new Edge<>("4", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge5 =
      new Edge<>("5", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge6 =
      new Edge<>("6", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge7 =
      new Edge<>("7", WayData.builder().tags(Map.of("name", "Walking")).build());
  private final static Edge<JunctionData, WayData> edge8 =
      new Edge<>("8", WayData.builder().tags(Map.of("addr:country", "PL")).build());
  private final static Edge<JunctionData, WayData> edge9 =
      new Edge<>("9", WayData.builder().tags(Map.of("addr:country", "PL")).build());
  ...
  private static Stream<Arguments> provideParamsForPredecessorTest() {
    return Stream.of(Arguments.of(edge1, "name", false), Arguments.of(edge2, "name", true),
        Arguments.of(edge3, "name", false), Arguments.of(edge3, "addr:country", true),
  ...
  private static Stream<Arguments> provideParamsForSuccessorTest() {
    return Stream.of(Arguments.of(edge4, "name", false), Arguments.of(edge5, "name", true),
        Arguments.of(edge6, "name", true), Arguments.of(edge7, "name", false),
