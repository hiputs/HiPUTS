...
public class TagCorrectorTest {
  ...
  private final static Node<JunctionData, WayData> nodeB = new Node<>("B", JunctionData.builder()
      .tags(new HashMap<>(){{put("highway", "traffic_signals");}}).build());
  private final static Node<JunctionData, WayData> nodeC = new Node<>("C", JunctionData.builder()
      .tags(new HashMap<>()).build());
  ...
  private static Stream<Arguments> provideParamsForEdgesCorrectionTest() {
    return Stream.of(
        Arguments.of("maxspeed", List.of(edge1), "70"),
        Arguments.of("maxspeed", List.of(edge3), "60"),
  ...
  public void trafficSignalsRemovalWhenNotExists() {
    // given
    TagCorrector tagCorrector = new TagCorrector(List.of(),
        List.of(Pair.of("traffic_signals", List.of(nodeC))));
  ...
  public void trafficSignalsRemovalWhenExists() {
    // given
    TagCorrector tagCorrector = new TagCorrector(List.of(),
        List.of(Pair.of("traffic_signals", List.of(nodeB))));
