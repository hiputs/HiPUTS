...
public class WrongConnectionsCorrectorTest {
  ...
  public void happyPath() {
    ...
    Edge<JunctionData, WayData> edge1 = new Edge<>("1", WayData.builder()
        .tags(new HashMap<>(){{put("highway", "primary");}}).length(2.0).build());
    ...
    Graph<JunctionData, WayData> graph = new Graph.GraphBuilder<JunctionData, WayData>()
        ...
        .addEdge(edge3)
        .build();
    WrongConnectionsCorrector corrector = new WrongConnectionsCorrector(
        List.of(typeIncompatibility1, typeIncompatibility2), new AddNewEdgeTypesFixer());
