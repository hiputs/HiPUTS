...
public class AllBridgesConnectFixerTest {
  ...
  private final AllBridgesConnectFixer creator =
      new AllBridgesConnectFixer(new DirectBridgesConnectFixer(new StandardEdgeReflector()),
          new IndirectBridgesConnectFixer(new StandardComplexCrossroadsUpdater(new StandardCrossroadDeterminer(),
              new ComplexCrossroadsRepositoryImpl(), new ModelConfigurationService())));
  ...
  public void happyPath() {
    ...
    Node<JunctionData, WayData> nodeA = new Node<>("A", JunctionData.builder().lon(50.1254876).lat(19.9106595).build());
    Node<JunctionData, WayData> nodeB = new Node<>("B", JunctionData.builder().lon(50.1257849).lat(19.9104581).build());
    Node<JunctionData, WayData> nodeC = new Node<>("C", JunctionData.builder().lon(50.1275802).lat(19.9123953).build());
    Node<JunctionData, WayData> nodeD = new Node<>("D", JunctionData.builder().lon(50.1274453).lat(19.9121929).build());
    ...
    // then
    creator.fixFoundDisconnections(List.of(sCC1, sCC2, sCC3), List.of(wCC1, wCC2), graph);
