...
public class IndirectBridgesConnectFixerTest {
  ...
  public void twoWCCsWithOneNodeInBoth() {
    // given
    Node<JunctionData, WayData> nodeA = new Node<>("A", JunctionData.builder().lon(50.1257849).lat(19.9104581).build());
    Node<JunctionData, WayData> nodeB = new Node<>("B", JunctionData.builder().lon(50.1274453).lat(19.9121929).build());
    WeaklyConnectedComponent wCC1 = new WeaklyConnectedComponent();
    WeaklyConnectedComponent wCC2 = new WeaklyConnectedComponent();
  ...
  public void threeWCCsWithNodesOnly() {
    ...
    // when
    Graph<JunctionData, WayData> graph =
        new Graph.GraphBuilder<JunctionData, WayData>().addNode(nodeA).addNode(nodeB).addNode(nodeC).build();
    wCC1.getNodesIds().add(nodeA.getId());
    wCC2.getNodesIds().add(nodeB.getId());
