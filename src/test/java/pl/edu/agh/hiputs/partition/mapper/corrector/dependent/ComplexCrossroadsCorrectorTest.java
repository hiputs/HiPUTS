...
public class ComplexCrossroadsCorrectorTest {
  ...
  public void singleNodeAsComplexCrossroad() {
    ...
    Node<JunctionData, WayData> nodeA =
        new Node<>("A", JunctionData.builder().tags(new HashMap<>()).lat(21.0).lon(30.0).build());
    ComplexCrossroad complexCrossroad = new ComplexCrossroad();
    ComplexCrossroadsRepositoryImpl complexCrossroadsRepository = new ComplexCrossroadsRepositoryImpl();
  ...
  public void twoNodesAsComplexCrossroads() {
    ...
    Node<JunctionData, WayData> nodeB =
        new Node<>("B", JunctionData.builder().tags(new HashMap<>()).lat(20.0).lon(31.0).build());
  ...
  public void threeNodesWithTwoComplexCrossroadsAndBendBetween() {
    ...
    Node<JunctionData, WayData> nodeC =
        new Node<>("C", JunctionData.builder().tags(new HashMap<>()).lat(21.0).lon(31.0).build());
    ComplexCrossroad complexCrossroad1 = new ComplexCrossroad();
    ComplexCrossroad complexCrossroad2 = new ComplexCrossroad();
    ComplexCrossroadsRepositoryImpl complexCrossroadsRepository = new ComplexCrossroadsRepositoryImpl();
  ...
  public void fiveNodesWithTwoComplexCrossroadsAndBend() {
    ...
    Node<JunctionData, WayData> nodeA =
        new Node<>("A", JunctionData.builder().tags(new HashMap<>()).lat(21.0).lon(30.0).build());
    Node<JunctionData, WayData> nodeB =
        new Node<>("B", JunctionData.builder().tags(new HashMap<>()).lat(20.0).lon(30.0).build());
    Node<JunctionData, WayData> nodeC =
        new Node<>("C", JunctionData.builder().tags(new HashMap<>()).lat(21.0).lon(31.0).build());
    Node<JunctionData, WayData> nodeD =
        new Node<>("D", JunctionData.builder().tags(new HashMap<>()).lat(20.0).lon(31.0).build());
    Node<JunctionData, WayData> nodeE =
        new Node<>("E", JunctionData.builder().tags(new HashMap<>()).lat(22.0).lon(32.0).build());
    ComplexCrossroad complexCrossroad1 = new ComplexCrossroad();
    ComplexCrossroad complexCrossroad2 = new ComplexCrossroad();
    ComplexCrossroadsRepositoryImpl complexCrossroadsRepository = new ComplexCrossroadsRepositoryImpl();
  ...
  public void complexGraph() {
    ...
    Node<JunctionData, WayData> nodeA =
        new Node<>("A", JunctionData.builder().tags(new HashMap<>()).lat(50.0945494).lon(19.8775622).build());
    Node<JunctionData, WayData> nodeB =
        new Node<>("B", JunctionData.builder().tags(new HashMap<>()).lat(50.0942335).lon(19.8788777).build());
    Node<JunctionData, WayData> nodeC =
        new Node<>("C", JunctionData.builder().tags(new HashMap<>()).lat(50.0932701).lon(19.8772253).build());
    Node<JunctionData, WayData> nodeD =
        new Node<>("D", JunctionData.builder().tags(new HashMap<>()).lat(50.0956796).lon(19.8784069).build());
    ComplexCrossroad complexCrossroad = new ComplexCrossroad();
    ComplexCrossroadsRepositoryImpl complexCrossroadsRepository = new ComplexCrossroadsRepositoryImpl();
