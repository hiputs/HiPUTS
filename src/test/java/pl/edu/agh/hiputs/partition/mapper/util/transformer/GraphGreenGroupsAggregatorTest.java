...
import pl.edu.agh.hiputs.partition.mapper.util.group.TwoByIndexGGRExtractor;
...
public class GraphGreenGroupsAggregatorTest {
  private final GraphGreenGroupsAggregator aggregator = new GraphGreenGroupsAggregator(
  ...
  public void transformGreenGroups() {
    ...
    // when
    crossroad.getData().setSignalsControlCenter(Optional.of(new StandardSignalsControlCenter()));
