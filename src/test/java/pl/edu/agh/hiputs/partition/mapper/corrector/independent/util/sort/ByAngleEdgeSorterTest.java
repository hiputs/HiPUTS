...
public class ByAngleEdgeSorterTest {
  ...
  public void sortEdges(
      ...
      List<Edge<JunctionData, WayData>> sorted, Edge<JunctionData, WayData> ref,
  ...
  private static Stream<Arguments> provideParamsForMultipleEdgesSorting() {
    ...
    return Stream.of(
        Arguments.of(List.of(firstEdge, secondEdge, thirdEdge), List.of(firstEdge, secondEdge, thirdEdge), refEdge,
            targetGetter, sourceGetter),
        Arguments.of(List.of(secondEdge, thirdEdge, firstEdge), List.of(firstEdge, secondEdge, thirdEdge), refEdge,
            targetGetter, sourceGetter),
        Arguments.of(List.of(firstEdge), List.of(firstEdge), refEdge, targetGetter, sourceGetter),
        Arguments.of(List.of(), List.of(), refEdge, targetGetter, sourceGetter),
        Arguments.of(List.of(reverseFirstEdge, reverseSecondEdge, reverseThirdEdge),
            List.of(reverseFirstEdge, reverseSecondEdge, reverseThirdEdge), refEdgeReverse, sourceGetter, targetGetter),
        Arguments.of(List.of(reverseSecondEdge, reverseThirdEdge, reverseFirstEdge),
            List.of(reverseFirstEdge, reverseSecondEdge, reverseThirdEdge), refEdgeReverse, sourceGetter, targetGetter),
        Arguments.of(List.of(reverseFirstEdge), List.of(reverseFirstEdge), refEdgeReverse, sourceGetter, targetGetter),
