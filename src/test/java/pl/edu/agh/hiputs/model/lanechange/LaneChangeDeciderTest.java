...
public class LaneChangeDeciderTest {
  ...
  void mandatoryLaneChange() {
    ...
    CarEditable currentCar =
        createCar(laneId30, lane30.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements2, 2),
            road_length - 150, 4.0);
  ...
  void noMandatoryLaneChange() {
    ...
    CarEditable currentCar =
        createCar(laneId31, lane31.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements2, 2),
            road_length - 150, 4.0);
  ...
  void changeLaneDecisionNoCarsTargetLaneInNoLaneChangeZone() {
    ...
    LaneEditable lane31 = mapFragment.getLaneEditable(laneId31);
    CarEditable followingCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 0),
            road_length - 20, 4.0);
    CarEditable currentCar =
        createCar(laneId31, lane31.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1),
            road_length - 20, 1.0);
