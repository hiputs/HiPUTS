...
public class ModelMobilTest {
  ...
  void changeLaneDecisionNoCarsTargetLane() {
    ...
    CarEditable followingCar =
        createCar(laneId11, lane11.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 0),
            road_length - 20, 4.0);
    CarEditable currentCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 2, 1.0);

    CarEditable precedingCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 10, 2.0);
  ...
  void changeLaneDecisionCarTargetLanePositionEqual() {
    ...
    CarEditable currentCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 2, 1.0);
    CarEditable adjacentCar =
        createCar(laneId20, lane20.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 2, 10.0);
  ...
  void changeLaneDecisionCarOnTargetLaneIncorrectDeceleration() {
    ...
    CarEditable followingCar =
        createCar(laneId11, lane11.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 0),
            road_length - 20, 4.0);
    CarEditable currentCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 10, 1.0);
    CarEditable adjacentCar =
        createCar(laneId20, lane20.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 2, 10.0);

    CarEditable precedingCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 20, 2.0);
  ...
  void changeLaneDecisionNewFollowingCarExists() {
    ...
    CarEditable currentCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 10, 1.0);
    CarEditable newFollowingCar =
        createCar(laneId10, lane10.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 2, 10.0);

    CarEditable precedingCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 0), 20, 2.0);
  ...
  void changeLaneDecisionNewPrecedingCarExists() {
    ...
    CarEditable currentCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 10, 1.0);
    CarEditable newFollowingCar =
        createCar(laneId10, lane10.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 0), 2, 10.0);

    CarEditable precedingCar =
        createCar(laneId21, lane21.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 20, 2.0);

    CarEditable newPrecedingCar =
        createCar(laneId30, lane30.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 2), 1, 2.0);
  ...
  void changeLaneDecisionNewPrecedingCarExistsSameRoad() {
    ...
    CarEditable newPrecedingCar =
        createCar(laneId20, lane20.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 100, 2.0);
  ...
  void changeLaneDecisionNewPrecedingCarExistsSameRoadTooClose() {
    ...
    CarEditable newPrecedingCar =
        createCar(laneId20, lane20.getRoadId(), new RouteWithLocation(modelMobilTestData.routeElements1, 1), 21, 2.0);
  ...
  // private CarEditable createCar(LaneId laneId, RoadId roadId, RouteWithLocation route, double position, double
  // speed, LaneId laneId2) {
  //   return Car.builder()
  //       .carId(CarId.random())
  //       .laneId(laneId)
  //       .roadId(roadId)
  ...
  //       .positionOnLane(position)
  //       .speed(speed)
  //       .decision(Decision.builder().speed(100.0).acceleration(2.0).offsetToMoveOnRoute(0).positionOnRoad(0)
  //       .roadId(roadId).laneId(laneId2).build())
  //       .build();
  // }
}
