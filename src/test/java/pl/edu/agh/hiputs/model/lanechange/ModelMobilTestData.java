...
public class ModelMobilTestData {
  ...
  public static ModelMobilTestData prepareTestData(double roadLength) {
    ...
    Lane lane10 = Lane.builder().laneId(laneId10).roadId(road1Id).length(roadLength).laneSuccessors(List.of(laneId20)).build();
    Lane lane20 = Lane.builder().laneId(laneId20).roadId(road2Id).length(roadLength).laneSuccessors(List.of(laneId30)).build();
    Lane lane30 = Lane.builder().laneId(laneId30).roadId(road3Id).length(roadLength).laneSuccessors(List.of(laneId40)).build();
    ...
    Lane lane11 = Lane.builder().laneId(laneId11).roadId(road1Id).length(roadLength).laneSuccessors(List.of(laneId21)).build();
    Lane lane21 = Lane.builder().laneId(laneId21).roadId(road2Id).length(roadLength).laneSuccessors(List.of(laneId31)).build();
    Lane lane31 = Lane.builder().laneId(laneId31).roadId(road3Id).length(roadLength).laneSuccessors(List.of(laneId41, laneId50, laneId51)).build();
    ...
    RoadBuilder road1Builder = Road.builder()
        .roadId(road1Id)
        .lanes(List.of(laneId10,laneId11))
        .length(roadLength);
    RoadBuilder road2Builder = Road.builder()
        .roadId(road2Id)
        .lanes(List.of(laneId20,laneId21))
        .length(roadLength);
    RoadBuilder road3Builder = Road.builder()
        .roadId(road3Id)
        .lanes(List.of(laneId30,laneId31))
        .length(roadLength);
    RoadBuilder road4Builder = Road.builder()
        .roadId(road4Id)
        .lanes(List.of(laneId40,laneId41))
        .length(roadLength);
    RoadBuilder road5Builder = Road.builder()
        .roadId(road5Id)
        .lanes(List.of(laneId50,laneId51))
        .length(roadLength);
    ...
    junction3Builder.addIncomingRoadId(road3Id, false)
        .addOutgoingRoadId(road4Id)
        .addOutgoingRoadId(road5Id);
    ...
    Patch localPatch = Patch.builder()
        ...
        .junctions(Map.of(junction0.getJunctionId(), junction0, junction1.getJunctionId(), junction1, junction2.getJunctionId(), junction2))
    ...
    Patch remotePatch = Patch.builder()
        ...
        .lanes(Map.of(laneId30, lane30, laneId31, lane31, laneId40, lane40, laneId41, lane41, laneId50, lane50, laneId51, lane51))
        .build();
    ...
    modelMobilTestData.allRoads = List.of(road1Builder.build(), road2Builder.build(), road3Builder.build(), road4Builder.build());
    modelMobilTestData.allLanes = List.of(lane10, lane11, lane20, lane21, lane30, lane31, lane40, lane41, lane50, lane51);
