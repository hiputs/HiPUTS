...
public class RoadStructureEditorTest {
  ...
  private TestData prepareTestData() {
    ...
    Road.RoadBuilder road1Builder = Road.builder()
        .roadId(road1Id)
        .lanes(Collections.singletonList(lane1.getLaneId()));
    Road.RoadBuilder road2Builder = Road.builder()
        .roadId(road2Id)
        .lanes(Collections.singletonList(lane2.getLaneId()));
    Road.RoadBuilder road3Builder = Road.builder()
        .roadId(road3Id)
        .lanes(Collections.singletonList(lane3.getLaneId()));
    Road.RoadBuilder road4Builder = Road.builder()
        .roadId(road4Id)
        .lanes(Collections.singletonList(lane4.getLaneId()));
